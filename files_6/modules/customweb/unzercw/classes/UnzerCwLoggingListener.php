...
class UnzerCwLoggingListener implements Customweb_Core_Logger_IListener
{
	public function addLogEntry($loggerName, $level, $message, Exception $e = null, $object = null){
		...
		oxRegistry::getUtils()->writeToLog($content, 'unzercw.log');
	}

	private function isLevelActive($level){
		switch (oxRegistry::getConfig()->getShopConfVar('unzercw_logging_level', null, 'module:unzercw')) {
			case 'debug':
				return true;
			case 'info':
